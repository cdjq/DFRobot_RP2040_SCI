...
if __name__ == "__main__":
  ...
  while True:
    ...
    #print("\r\n\r\n")
    Temp_Air_val  = sci.get_value0("Temp")
    Temp_Air_unit = sci.get_unit0("Temp")
    Humi_Air_val  = sci.get_value0("Temp")
    Humi_Air_unit = sci.get_unit0("Temp")
    print("Temp_Air1:%s %s, Humi_Air:%s %s"%(Temp_Air_val, Temp_Air_unit, Humi_Air_val, Humi_Air_unit))
    Temp_Air_val  = sci.get_value1(sci.eALL,"Temp")
    Temp_Air_unit = sci.get_unit1(sci.eALL,"Temp")
    Humi_Air_val  = sci.get_value1(sci.eALL,"Temp")
    Humi_Air_unit = sci.get_unit1(sci.eALL,"Temp")
    print("Temp_Air2:%s %s, Humi_Air:%s %s"%(Temp_Air_val, Temp_Air_unit, Humi_Air_val, Humi_Air_unit))
    Temp_Air_val  = sci.get_value2(sci.eALL,"SEN0206","Temp")
    Temp_Air_unit = sci.get_unit2(sci.eALL,"SEN0206","Temp")
    Humi_Air_val  = sci.get_value2(sci.eALL,"SEN0206","Temp")
    Humi_Air_unit = sci.get_unit2(sci.eALL,"SEN0206","Temp")
    print("Temp_Air3:%s %s, Humi_Air:%s %s"%(Temp_Air_val, Temp_Air_unit, Humi_Air_val, Humi_Air_unit))
    print("\r\n\r\n")
    time.sleep(1)
